...
export default function SimpleGoalModal({ isOpen, onClose, onGoalCreated }: SimpleGoalModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const goal = await GoalsService.createGoal({
        ...formData,
        unit: formData.unit.toLowerCase() // Converter para minúsculo para compatibilidade
      });
