          ...
          <div className="prose prose-sm max-w-none">
            <div className="mb-4 text-sm text-gray-600">
              {privacyPolicy.version && (
                <p><strong>Versão:</strong> {privacyPolicy.version}</p>
              )}
              {privacyPolicy.effectiveDate && (
                <p><strong>Data de vigência:</strong> {privacyPolicy.effectiveDate}</p>
              )}
            </div>
        ...
        {!hasScrolledToEnd && (
          <div className="px-6 py-2 bg-yellow-50 border-t border-yellow-200">
            <p className="text-sm text-yellow-800 text-center">
              ⬇️ Role até o final para habilitar a opção de aceitar a política
            </p>
          </div>
        )}
          ...
          <div className="mb-4">
            <label className="flex items-start space-x-3 cursor-pointer">
              ...
              <span className={`text-sm ${
                ...
                Li e aceito a Política de Privacidade do Genoma
              </span>
            </label>
          </div>
