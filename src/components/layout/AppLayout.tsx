...
const AppLayout = ({ children }: AppLayoutProps) => {
  ...
  return (
    <NotificationProvider>
      ...
      {/* Sidebar - Desktop */}
      <div 
        className={`bg-blue-600 text-white flex flex-col transition-all duration-300 ease-in-out fixed left-0 top-0 h-full z-30 ${
      ...
      {/* Main content */}
      <div className={`min-h-screen flex flex-col overflow-x-hidden transition-all duration-300 ease-in-out ${
        ...
        {/* Page content */}
        <main className="flex-1 px-3 py-0 sm:px-6 sm:py-6 lg:px-8 bg-gray-50 max-w-full w-full pb-20 md:pb-6 overflow-x-hidden">
          {children}
        </main>
      </div>
