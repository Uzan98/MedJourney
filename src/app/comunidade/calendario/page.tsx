                ...
                {events.map((event) => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className="flex-shrink-0 w-12 h-12 bg-white rounded-lg flex flex-col items-center justify-center border border-gray-100">
                ...
                <p className="text-gray-600 mb-4">
                  {activeTab === 'exams' 
                    ...
                    : activeTab === 'assignments'
                      ? 'Não há trabalhos para entregar no momento.'
                      : activeTab === 'upcoming'
                        ? 'Não há eventos próximos agendados.'
                        : 'Não há eventos no calendário.'}
                </p>
                <Button className="bg-amber-600 hover:bg-amber-700 text-white">
                  <Plus className="h-4 w-4 mr-2" />
                  Adicionar Evento
