...
-- Criar nova função get_discipline_attendance_stats para aceitar academic_subject_id
...
BEGIN
    ...
    WHERE id = academic_subject_id AND user_id = user_id_param::text;
    ...
    INTO total_abs
    FROM absences a
    WHERE a.academic_subject_id = academic_subject_id AND a.user_id = user_id_param::text;
